...
export default function ResponseUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = responseRecord
      ? { ...initialValues, ...responseRecord, Team, Appointment }
      : initialValues;
  ...
  React.useEffect(() => {
    const queryData = async () => {
      ...
      setTeam(TeamRecord);
      const AppointmentRecord = record ? await record.Appointment : undefined;
      setAppointment(AppointmentRecord);
    };
    queryData();
  }, [idProp, responseModelProp]);
  React.useEffect(resetStateValues, [responseRecord, Team, Appointment]);
        ...
        try {
          ...
          await DataStore.save(
            Response.copyOf(responseRecord, (updated) => {
              ...
              if (!modelFields.Appointment) {
                updated.appointmentID = undefined;
              }
            })
          );
          if (onSuccess) {
