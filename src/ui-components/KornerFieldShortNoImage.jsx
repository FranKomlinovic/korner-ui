...
export default function KornerFieldShortNoImage(props) {
  const { fields, overrides, ...rest } = props;
  const kornerFieldShortNoImageOnClick = useNavigateAction({
    type: "url",
  ...
  return (
    <Flex
      ...
      onClick={() => {
        kornerFieldShortNoImageOnClick();
      }}
      {...getOverrideProps(overrides, "KornerFieldShortNoImage")}
      {...rest}
    >
      <Text
        fontFamily="Inter"
      ...
      <Flex
        ...
        {...getOverrideProps(overrides, "address37902733")}
      >
        <Flex
          gap="10px"
          direction="row"
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Icon37902734")}
        >
          <Icon
            width="25px"
            height="25px"
            ...
            shrink="0"
            position="relative"
            {...getOverrideProps(overrides, "Vector37902735")}
          ></Icon>
        </Flex>
        <Text
          fontFamily="Inter"
          ...
          {...getOverrideProps(overrides, "address37902736")}
        ></Text>
      </Flex>
      <Flex
        gap="13px"
        ...
        position="relative"
        padding="0px 0px 0px 13px"
        {...getOverrideProps(overrides, "price37902737")}
      >
        <Flex
          gap="10px"
          direction="row"
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Icon37902738")}
        >
          <Icon
            width="25px"
            height="25px"
            ...
            shrink="0"
            position="relative"
            {...getOverrideProps(overrides, "Vector37902739")}
          ></Icon>
        </Flex>
        <Text
          fontFamily="Inter"
          ...
          {...getOverrideProps(overrides, "price37902740")}
        ></Text>
      </Flex>
    </Flex>
  );
